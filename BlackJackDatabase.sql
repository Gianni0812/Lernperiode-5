...
/****** Object:  Database [BlackJack]    Script Date: 02.05.2025 11:27:55 ******/
CREATE DATABASE [BlackJack]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'BlackJack', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.FIRSTDATABANK\MSSQL\DATA\BlackJack.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'BlackJack_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.FIRSTDATABANK\MSSQL\DATA\BlackJack_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [BlackJack] SET AUTO_CLOSE ON 
GO
...
ALTER DATABASE [BlackJack] SET RECOVERY SIMPLE 
GO
...
ALTER DATABASE [BlackJack] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
